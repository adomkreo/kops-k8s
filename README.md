...
# 8) Create kubernetes cluster v1.27.7 9WE ARE NOT USING THIS VERSION BECAUSE IT IS NOT COMPATIBLE WITH RANCHER SO WE CHOOSE V1.28.15 INSTEAD definitions on S3 bucket
```sh
